...
export const FALLBACK_OPPORTUNITIES: YieldOpportunity[] = [
  {
    ...
    screeningReasons: ["Morpho listed", "TVL above $50M", "Liquidity above 20% of TVL", "Positive Morpho instant net APY"],
    listed: true,
  ...
  },
  {
    ...
    screeningReasons: ["Not Morpho listed", "TVL above $50M", "Liquidity above 10% of TVL", "Positive Morpho instant net APY"],
    listed: false,
