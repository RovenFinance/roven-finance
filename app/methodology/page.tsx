...
export default function MethodologyPage() {
  return <LegalPage eyebrow="Methodology · Version 2026-07-24.1" title="What Roven measures—and what it does not." intro="Roven is a read-only screening and comparison layer. Its Market Quality score summarizes observable market data; it is not a security rating, audit, endorsement or prediction of loss.">
    ...
    <section><h2>Eligibility screen</h2><p>A result must use canonical USDG, report a positive Morpho instant net APY and either be Morpho-listed or report at least $10 million in TVL. Unlisted opportunities remain visibly marked as unlisted.</p></section>
    ...
    <section><h2>Data timing</h2><p>Displayed Net APY matches Morpho’s Instant Net APY field from the Morpho GraphQL API (after fees, including rewards). Rates are variable. Every application response includes a snapshot timestamp and source status. If the live source fails, Roven shows an explicitly dated stale snapshot and disables any claim that the data is live.</p></section>
